...
class EnergyBreakDown extends StatefulWidget {
  final int user_id;
  const EnergyBreakDown({ Key? key ,required this.user_id,}) : super(key: key);

  @override
  _EnergyBreakDownState createState() => _EnergyBreakDownState();
}

class _EnergyBreakDownState extends State<EnergyBreakDown> {
    int show=1;
    var userData;
    var userToken;
    var userid;
                              ...
                              SliverPersistentHeader(
                                  ...
                                  delegate: CustomSliverDelegate(
                                    ...
                                    aligncontainerwidget: MyListContainer(
                                      ...
                                      sub_title: snapshot.data!.total_units.toString()+ " kWh",
                                      ),
                                            ...
                                            BoxShadow(
                                              ...
                                              offset: Offset(10,30)
                                                              ...
                                                              child: MyListContainer(
                                                                title: transactions_items[index]['product_name'] + " -" + transactions_items[index]['units'].toString()+ " kWh",
                                                                //title: 'Buy Units:34 ',
